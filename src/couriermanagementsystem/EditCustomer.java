...
public class EditCustomer {
	public EditCustomer(String oldName){
		JFrame frame = new JFrame();
		HashMap<String, String> data = Main.customerManager.getCustomer(oldName);
		frame.setTitle("Client Management System");
		JPanel panel = (JPanel) frame.getContentPane();
		GroupLayout gl = new GroupLayout(panel);
		panel.setLayout(gl);
		gl.setAutoCreateContainerGaps(true);
		JLabel pageHeader = new JLabel("Edit Client");
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String name = nameField.getText();
		  		...
		  		if(Main.customerManager.editCustomer(location, name, contact, oldName)){
		  			Main.raiseAlert("Client Edited Successfully");
		  			frame.dispose();
		...
		locationField.setSelectedItem(data.get("location"));
